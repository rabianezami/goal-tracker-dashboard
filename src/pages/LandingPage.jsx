                    ...
                    <Grid container spacing={3} justifyContent="center">
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card sx={{ p: 2, textAlign: "center" }}>
                                <CardContent>
                                    <Typography variant="h5">{t("page.GOAL_TRACKING")}</Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card sx={{ p: 2, textAlign: "center" }}>
                                <CardContent>
                                    <Typography variant="h5">{t("page.FOCUS_SYSTEM")}</Typography>
                                    <Typography variant="body2">
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card sx={{ p: 2, textAlign: "center" }}>
                                <CardContent>
                                    <Typography variant="h5">{t("page.PROGRESS_INSIGHTS")}</Typography>
                                    <Typography variant="body2">
                ...
                <Box sx={{ maxWidth: 900, mx: "auto" }}>
                    ...
                    <Card
                        sx={{
                            ...
                            overflow: "hidden",
                            background:
                                "linear-gradient(270deg, primary.main, primary.light, primary.dark)",
